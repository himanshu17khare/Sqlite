...
public class PetProvider extends ContentProvider {
    ...
    private int updatePets(Uri uri, ContentValues contentValues, String selection, String[] selectionArgs) {
        ...
        if (contentValues.containsKey(PetContract.PetEntry.name)) {
            String name = contentValues.getAsString(PetContract.PetEntry.name);
            if (name == null) {
                throw new IllegalArgumentException("Pet requires a name");
            }
        ...
        if (contentValues.containsKey(PetContract.PetEntry.gender)) {
            Integer gender = contentValues.getAsInteger(PetContract.PetEntry.gender);
            if (gender == null || !PetContract.PetEntry.isValidGender(gender)) {
                throw new IllegalArgumentException("Pet requires valid gender");
            }
        ...
        if (contentValues.containsKey(PetContract.PetEntry.weight)) {
